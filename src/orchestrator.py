...
def e1_write(job) -> dict:
    ...
    formulas = {
        "fashion": [
            # 30초판 (10문장) — 박진감 변주 강화 (형 피드백 08-27)
            ("{p} 신는 사람 5가지 실수, 알고 계셨나요?", "hook", "+20%", "+25Hz"),
            ("첫 번째, 바지단이 길어서 신발이 안 보여요", "body", "+12%", "+5Hz"),
            ("두 번째, 색이 너무 많아서 포인트가 사라져요", "body", "+12%", "+5Hz"),
            ("세 번째! 양말로 다 망칩니다", "pop", "+18%", "+18Hz"),
            ("네 번째, 제일 흔한 화이트 on 화이트는 이제 지겨죠", "body", "+14%", "+8Hz"),
            ("다섯 번째, 사이즈 잘못 골라서 뒷꿈치가 다 까져요", "body", "+12%", "+5Hz"),
            ("근데 이렇게만 바꿔도, 코디가 완전 달라져요", "pop", "+16%", "+15Hz"),
            ("청바지? 수트? 전부 정답이에요", "pop", "+18%", "+18Hz"),
            ("디테일까지 살아있는 마감 보고 가세요", "body", "+14%", "+10Hz"),
            ("지금이, 제일 싼 시즌이에요!", "cta", "+22%", "+28Hz"),
        ],
        "game": [
