...
OUT = BASE / "data/shorts_out/nike_airforce_v6.mp4"
TMP = BASE / "data/shorts_out/tmp_v6"
...
SCRIPT = [
    ...
    ("화이트 하나로 코디 완성!", '+8%', '+10Hz', 'pop'),
    ("가죽 광택까지 살아있는 디테일", '+2%', '-6Hz', 'body'),
    ("지금이, 제일 싼 시즌이에요", '+15%', '+22Hz', 'cta'),
]
STILLS = [
    BASE / "data/shorts_assets/44a1b72c9e_w0.png",  # 화이트
    BASE / "data/shorts_assets/44a1b72c9e_w1.png",  # 화이트2
    BASE / "data/shorts_assets/24ff718a60_w0.png",  # 블랙
    BASE / "data/shorts_assets/f521f0f22f_w0.png",  # 탠
    BASE / "data/shorts_assets/f521f0f22f_w1.png",  # 탠2
]
